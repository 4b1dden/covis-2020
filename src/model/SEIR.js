...
export const seirModel = (initialValues: InitialValues, params: Params, tList) => {
  ...
  let { alpha, beta, gamma, isQuarantined, quarantinePower = 1, hospitalizationRate = 0.3, fatalityRate = 0.037, hospitalizationTime = 10} = params;
  const dt = tList[1] - tList[0];

  beta = isQuarantined ? beta * quarantinePower : beta;
